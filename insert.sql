...
insert into subjects values(1,'C, UNIX, Technology');
insert into subjects values(2,'Go, Technology');
insert into subjects values(3,'UNIX, Technology');
insert into subjects values(4,'Technology, Science Fiction');
insert into subjects values(5,'Technology, Productivity');
insert into subjects values(6,'Productivity, Psychology');
insert into subjects values(7,'Science Fiction, Politics');
insert into subjects values(8,'Politics, History');
...
insert into books_subjects values(5,5);
insert into books_subjects values(6,6);
insert into books_subjects values(7,7);
